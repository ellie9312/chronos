...
void addToIncSet(saddr_p m,worklist_p *prvNode,worklist_p *strNode, loop_t *lp, tc_p tc);
...
void PS_update(scp_acs acs_out, worklist_p addr_set, loop_t *lp, tc_p tc);
